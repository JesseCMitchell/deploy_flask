    ...
    def get_one(cls, data:dict) -> list:
        ...
        if results:
            ...
            for dictionary in results:
                data = {
                    'id': dictionary['recipes.id'],
                    'created_at': dictionary['recipes.created_at'],
                    'updated_at': dictionary['recipes.updated_at'],
                    'recipe_name': dictionary['recipe_name'],
                    'description': dictionary['description'],
                    'instructions': dictionary['instructions'],
                    'date_made': dictionary['date_made'],
                    'under_thirty': dictionary['under_thirty'],
                    'user_id': dictionary['user_id']
                }
                user.recipe_list.append(model_recipe.Recipe(data) )
            return user    
        return False
